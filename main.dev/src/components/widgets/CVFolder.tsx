...
const CVFolder = () => {
  return (
    <a
      ...
      title="Download CV"
    >
      <div className="relative w-24 h-20 transition-transform duration-300 group-hover:scale-110 cursor-pointer">
        ...
        <div className="absolute inset-x-2 bottom-2 top-2 bg-gray-200 rounded-sm shadow-sm transition-all duration-500 ease-out group-hover:-translate-y-8 group-hover:rotate-2 flex flex-col items-center p-2 z-10">
        ...
        <div className="absolute inset-0 bg-[#1e1e1e] rounded-lg border-2 border-gray-600 border-t-[3px] shadow-inner z-20 flex items-center justify-center transition-all duration-500 origin-bottom ease-[cubic-bezier(0.4,0,0.2,1)] group-hover:[transform:rotateX(-25deg)_translateY(5px)]">
